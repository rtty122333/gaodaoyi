// 农历数据表 (1900..2100) —— 由 _lunar_table.py 生成, 勿手改
//
// 每年一个 uint32_t:
...
//
// 数据来源与交叉验证(详见 _lunar_table.py):
//   主来源 lunar_python(寿星天文历, 天文算法)
//   已与 lunarcalendar(香港天文台数据)逐日全量比对一致
//   与 lunardate 经典表仅 1933/1954/1978/2057 四年差一天(朔日边界历史争议,
//   那四年上香港天文台数据与主来源一致, 故采信主来源)

#pragma once
#include <stdint.h>

#define LUNAR_YEAR0   1900
#define LUNAR_YEAR1   2100
#define LUNAR_COUNT   201

static const uint32_t LUNAR_INFO[LUNAR_COUNT] = {
